...
export default function Configuracoes() {
  ...
  const handleSave = async (e) => {
    ...
    if (res.error) toast.error('Erro ao guardar')
    else { toast.success('Guardado com sucesso!'); setSaved(true); setTimeout(() => setSaved(false), 3000) }
    setCarregando(false)
  }
